...
func TestBuildReport(t *testing.T) {
	...
	_, err = s.CreateVerdict(ctx, sess.ID, traceID, "GET /api/health", "pass", 0.95, "judge", "endpoint healthy", nil)
	require.NoError(t, err)
...
func TestRenderMarkdown(t *testing.T) {
	...
	_, _ = s.CreateVerdict(ctx, sess.ID, traceID, "POST /api/login", "pass", 0.9, "judge", "login works correctly", nil)
...
func TestRenderHTML(t *testing.T) {
	...
	_ = s.FinishTrace(ctx, traceID, "pass")
	_, _ = s.CreateVerdict(ctx, sess.ID, traceID, "GET /api/users", "pass", 0.88, "judge", "users endpoint responds", nil)
...
func TestBuildReport_MultipleVerdicts(t *testing.T) {
	...
	_, _ = s.CreateVerdict(ctx, sess.ID, trace1, "GET /a", "pass", 0.9, "judge", "ok", nil)
	_, _ = s.CreateVerdict(ctx, sess.ID, trace2, "POST /b", "fail", 0.3, "judge", "server error", nil)
